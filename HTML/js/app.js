(() => {
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".btn-close")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".btn-close")) {
                    bodyLockToggle();
        ...
        if (document.querySelector(".metal__slider")) new Swiper(".metal__slider", {
        ...
        function initSliders() {
            ...
            if (sliderElement) if (window.innerWidth < 1367 && !projectsSlider) projectsSlider = new Swiper(sliderElement, {
            ...
            if (newsElement) if (window.innerWidth < 1367 && !newsSlider) newsSlider = new Swiper(newsElement, {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (clientsElement) if (window.innerWidth < 768 && !clientsSlider) clientsSlider = new Swiper(clientsElement, {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        if (document.querySelector(".about-trust__slider")) new Swiper(".about-trust__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        menuItems.forEach((item => {
            ...
            item.addEventListener("click", (function(e) {
                ...
                menuItems.forEach((el => {
                    ...
                    if (elSub) elSub.style.height = "0px";
                }));
                if (!isOpen && submenu) {
